...
/**
 * typedef struct fmt fmt_t - struct program
 * @fmt: format
 * @fn: function
 */
...
int print_percent(va_list types, char buffer[],i
...
/*FUNCTIONS FOR REVERSE STRING PRINT*/
int print_reverse(va_list types, char buffer[],
		int flags, int width, int precision, int size);

/*FUNCTIONS FOR STRING PRINT*/
